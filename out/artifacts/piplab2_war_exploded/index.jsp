...
<header>
  <table>
    ...
    <tr>
      <td colspan="2"><h2>Комаров Егор Андреевич</h2></td>
      <td colspan="2"><h2>Чернышев Никита Евгеньевич</h2></td>
    </tr>
    <tr>
      <td><h3 class="left-header">Вариант: 18107</h3></td>
        ...
        <form id = "mainForm" method="POST" action="php.php">
          <fieldset>
            <table>
              ...
              <tr>
                <td colspan="2">
                  <table  class="paramTable">
                    <tr>
                      <td>
                        <label><input class="radioSel" type="radio" name="yParam" value="-2" required>-2.0</label>
                      </td>
                      <td>
                        <label><input class="radioSel" type="radio" name="yParam" value="0.5" required>0.5</label>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <label><input class="radioSel" type="radio" name="yParam" value="-1.5" required>-1.5</label>
                      </td>
                      <td>
                ...
                <td>
                  <table  class="paramTable">
                    ...
                    <tr>
                      <td>
                        <label><input class="radioSel" type="radio" name="rParam" value="1.5" required>1.5</label>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <label><input class="radioSel" type="radio" name="rParam" value="2" required>2.0</label>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <label><input class="radioSel" type="radio" name="rParam" value="2.5" required>2.5</label>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <label><input class="radioSel" type="radio" name="rParam" value="3" required>3.0</label>
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td colspan="3">
                  <input type="text" name="xParam" placeholder="Введите число от -5 до 5" maxlength="10" oninput="return inputX(this);" onchange="return changeX(this);" required>
                </td>
              </tr>
            </table>
          </fieldset>
